...
class FoodListView extends StatelessWidget {
  ...
  final Widget? icon;
  final Function(FoodData)? onPressed;

  const FoodListView(
      {Key? key, required this.foodList, this.icon, this.onPressed})
      : super(key: key);
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            context.pushNamed(Routes.detailsScreen, arguments: [food, heroTag]);
          },
          child: Padding(
              ...
              child: Stack(children: [
                ...
                if (icon != null)
                  Positioned(
                    ...
                    right: 0,
                    child: IconButton(
                        onPressed: () => onPressed!(food), icon: icon!),
                  ),
              ]),
            ),
          ),
