...
class TextStyles {
  static String appFontFamily = 'Quicksand';
  ...
  static TextStyle font18OrangeSemiBold = TextStyle(
      fontSize: 18.sp,
      fontWeight: FontWeightHelper.semiBold,
      color: ColorsManager.mainOrange,
      fontFamily: appFontFamily);
  ...
  static TextStyle font14SteelGrayRegular = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeightHelper.regular,
      color: ColorsManager.steelGray,
      fontFamily: appFontFamily);
  ...
  static TextStyle font12SteelGrayRegular = TextStyle(
      fontSize: 12.sp,
      fontWeight: FontWeightHelper.regular,
      color: ColorsManager.steelGray,
      fontFamily: appFontFamily);
