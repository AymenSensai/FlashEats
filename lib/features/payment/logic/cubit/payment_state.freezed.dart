...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$PaymentStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements PaymentState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$PaymentStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'PaymentState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements PaymentState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$PaymentStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'PaymentState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements PaymentState<T> {
